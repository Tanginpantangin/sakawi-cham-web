...
export declare type EventType = 'AkaokThun' | 'RijaNagar' | 'KatePaleiHamuTanran' | 'KateAngaokBimong' | 'CaMbur' | 'Lakhah' | 'AwalNewYear' | 'TamaRicaowRamawan' | 'TalaihAekRamawan' | 'MukTrun' | 'OngTrun' | 'IkakWaha' | 'TalaihWaha' | 'YuerYang' | 'VietnameseLunarNewYear';
